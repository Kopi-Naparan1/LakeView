...
import image1 from "../../../../../IMAGES/Ready/MenuAVIF/food1.avif";
import image2 from "../../../../../IMAGES/Ready/MenuAVIF/food2.avif";
import image3 from "../../../../../IMAGES/Ready/MenuAVIF/food3.avif";
import image4 from "../../../../../IMAGES/Ready/MenuAVIF/food4.avif";
import image5 from "../../../../../IMAGES/Ready/MenuAVIF/food5.avif";
import image6 from "../../../../../IMAGES/Ready/MenuAVIF/food6.avif";
...
export default function MenuPreview() {
  return (
    <section className="relative w-full py-24 bg-background lg:py-32">
      <div className="flex flex-col gap-16 site-container">
        {/* Header */}
        <div className="flex flex-col max-w-2xl gap-5">
          <span className="text-xs font-semibold tracking-[0.25em] uppercase text-primary/60">
            Menu Preview
          </span>
          ...
          <p className="text-base leading-relaxed text-primary/75 sm:text-lg">
            From handcrafted espresso drinks to satisfying meals and desserts,
            enjoy food that pairs perfectly with the relaxing view of Lake Apo.
          </p>
        </div>
